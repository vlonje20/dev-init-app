...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-black w3-wide w3-padding w3-card">
            <a href="#home" class="w3-bar-item w3-button"><b>.iNit  <span style="color: red;"> Technologies</span></b></a>
            ...
            <div class="card w3-card-4">
              ...
              <div class="content w3-container">
                <div class="card-text" style="padding-bottom: 20px;">
                  <h4>What we are about in <b>.iNit Technologies</b></h4>
    ...
    <footer class="w3-center w3-black w3-padding-16">
        ...
        <a class="w3-button w3-round-xxlarge w3-small w3-red w3-margin-bottom" href="https://www.w3schools.com/spaces" target="_blank">Thanks!</a>
    <!-- Footer end. -->
    </footer>
