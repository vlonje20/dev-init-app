...
<body>
    ...
    <div class="w3-top">
        <div class="w3-bar w3-white w3-wide w3-padding w3-card">
            <a href="#home" class="w3-bar-item w3-button"><b>Vin  |</b> Technologies</a>
    ...
    <header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
        ...
        <div class="w3-display-middle w3-margin-top w3-center">
            <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-red w3-opacity-min"><b>CICD</b></span> <span
                    class="w3-hide-small w3-text-light-grey"><b>|  Jenkins</b></span></h1>
        </div>
    </header>
    ...
    <div class="w3-content w3-padding" style="max-width:1564px">
        ...
        <div class="w3-container w3-padding-32" id="Manila City">
            ...
            <p>I wanted to take a moment to express my utmost admiration and respect for each and every one of you. 
              ...
              effective communication, the importance of adaptability, and the value of perseverance. These qualities have shaped us into a team 
              that thrives in the face of adversity, always finding innovative solutions to complex problems.
            </p>
        ...
        <div class="w3-container">
            <img src="https://vin-project.s3.amazonaws.com/project-images/homepage.jpg" class="w3-image" style="width:100%">
        </div>
